 ...
 * @param [options]
 */
export function shallow<P, S>(node: ReactElement<P> | null, options?: ShallowRendererProps): ShallowWrapper<P, S>;
 ...
 * @param [options]
 */
export function mount<P, S>(node: ReactElement<P> | null, options?: MountRendererProps): ReactWrapper<P, S>;
